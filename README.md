...
|--------------|-----------------------------------|-------------------|------------|---------------|
| ***0.1.13*** | 調整程式輸出文字內容與顯示效果                   | 正在設計 (Designing)  | 高 (High)   | ***2025-08*** |
| ***0.1.13*** | 更新 `USER.md` 與 `DEVELOPER.md` 的內容 | 正在設計 (Designing)  | 中 (Medium) | ***2025-08*** |
| ***0.1.13*** | 新增一些驚喜的小彩蛋，供使用者發掘，提升用戶體驗          | 正在設計 (Designing)  | 低 (Low)    | ***2025-08*** |
