            ...
            try:
                ...
                match trans_list[trans]:
                    ...
                    case "臺北捷運+環狀線":  # 呼叫 臺北捷運+環狀線 專用輸入函式
                        print("\033[38;5;111m這裡是「數據輸入平臺」，請輸入您本月\033[38;5;43m「臺北捷運+環狀線」\033[38;5;111m的搭乘數據\033[0m")
                    ...
                    case "大臺北地區 市區公車":  # 呼叫 大臺北地區 市區公車 專用輸入函式
                        print("\033[38;5;111m這裡是「數據輸入平臺」，請輸入您本月\033[38;5;43m「大臺北地區 市區公車」\033[38;5;111m的搭乘數據\033[0m")
                        print("如果程式詢問金額沒有本月對應的搭乘次數，請輸入半形數字 0")
                        for m in bus_price:
                        ...
                        print("\033[38;5;43m正在返回「交通選擇平臺」\033[0m\n")  # 輸出提示訊息
                    case _:  # 呼叫 一般輸入函式
                        print("\033[38;5;111m這裡是「數據輸入平臺」，請輸入您本月\033[38;5;43m「{}」\033[38;5;111m的搭乘數據\033[0m".format(trans_list[trans]))
