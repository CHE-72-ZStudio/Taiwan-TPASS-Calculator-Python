        ...
        try:
            ...
            match city:
                ...
                case 5:  # 城市5：北宜生活圈
                    ...
                    match plan:
                        case 1:  # 月票1：北宜跨城際及雙北 $2,300
                            trans_list = ["結束輸入，開始計算", "北宜通勤國道客運", "臺灣鐵路", "臺北捷運+環狀線", "大臺北地區 市區公車", "宜蘭縣 市區公車", "新北捷運/輕軌", "桃園捷運", "桃園/基隆 市區公車", "結束程式運行"]
                            price = 2300
